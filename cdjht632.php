...
<a href=cdjht632.php>HOME</a>&nbsp;&nbsp;
<br><pre>$programtext</pre><br>";
...
?>
<form method=GET action=cdjht632.php>student id:
<input type=text maxlength=20 name=cname value='cd1234'><br>
<textarea cols=60 rows=5 name=program>
&lt;?php
<?php
if(!empty($programtext)) {
  echo 'echo "$programtext";\n';
}
else {
